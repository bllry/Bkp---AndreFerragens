...
<img src="img/engrenagem.gif" width="80" alt="" style="float:left;"><img src="img/engrenagem.gif" width="80" alt="" style="float:right;">
           ...
           <h1 style="text-align:center;color: rgb(0, 32, 96);text-shadow: 2px 2px 2px #c9c9c9;font-size: 50px;margin: 1% 0" class="titulo">Controle de usuarios</h1>
                ...
                <table class="table table-hover"  style="overflow:auto;">
                   <thead>
                    ...
                    <td>
                            ...
                            <a data-toggle="modal" data-target="#ExcluUsu<?php echo $usuarios['id'] ?>" style="color:red;" id="Excluir" href="ExcluiProd.php/?id=<?php echo $row['id_prod']; ?>"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i></a>
                    </td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div>
                                        <div class="card">  
                                            <div class="card-header">
                                                <h3 class="card-title">Deseja Excluir <?php echo $usuarios['nome'] ?> da lista de administradores ?</h3>
                                            </div> 
                                        <div class="card-body">
                                            ...
                                            <form action="EditUsuario.php" method="post">
                                                    ...
                                                    <input required id="email" name="email" class="form-control" type="email" requiered value="<?php echo $usuarios['email'] ?>">
                                                        ...
                                                        <select requiered class="form-control" name="acesso" id="acesso">
                                                            <option value="" disabled="disabled" selected><?php echo $usuarios['tipo'] ?></option>
