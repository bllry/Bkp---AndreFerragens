...
background: linear-gradient(183deg, rgba(2,0,36,0.8883928571428571) 0%, rgba(9,9,121,1) 100%);
...
<!--
                <div class="col-sm-6" id="LogoBox">
                   <a href="inicio.php"><img width="90" src="img/LogoProjeto.png" alt="" class="navbar-brand Logo"></a>
               </div> -->
            
                 
               <div class="col-sm-7" id="LogoBox">
                   <a href="inicio.php"><img style="margin-bottom: 3%;margin-left:9%;" width="55%" src="img/LogoProjeto2.png" alt="" class="navbar-brand Logo"></a>
               </div>

                  
                    <div class="CaixaLog col-sm-5" >
                        
                        <button colspan="2" id="Ent" class="botaoCad" data-toggle="modal" data-target="#modalExemploLog" ><i class="fa fa-user" aria-hidden="true"></i> Entrar</button>
