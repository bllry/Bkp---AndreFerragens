                                            ...
                                            <div class="form-group">
                                                ...
                                                <!--<div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input value="<?php $row['img'] ?>" name="Img" requiered type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                                        ...
                                        <!-- RESOLVER FORMULARIO -->
                                            <form action="EditarProduto.php" method="post">
                                                ...
                                                <div style="display:none;" class="form-group">
                                                    <input name="id"  required id="nome" placeholder="Digite o novo texto" class="form-control" type="text" value="Identificação: <?php echo $row['id_prod']; ?>">
                                                    
                                                </div>
                                                -->
                                                <div class="form-group">
                                                    <label for="nome">Novo nome:</label>
                                                    <input id="nome" placeholder="Digite o novo texto" name="nome" class="form-control" type="text" value="<?php echo $row['nome_prod'] ?>" required>
                                                </div>

                                                <div class="form-group">
                                                    <label for="cat">Escolha a nova categoria:</label>
                                                    <select id="cat" style="color:#6c757d;" class="form-control" name="Cat" id="Categoria">
